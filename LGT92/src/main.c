...
void AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az,
  ...
  // wx,wy,wz Is the representation of the earth's magnetic field in the object
  // coordinate system
  ...
  // ex,ey,ezIt is the error between the acceleration and the measured direction
  // of the magnetometer and the actual gravity acceleration and the geomagnetic
  // direction.
